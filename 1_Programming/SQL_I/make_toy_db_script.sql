...
FROM '/home/ian/Galvanize/1_Programming/SQL_I/student_data.csv'
DELIMITER ',' CSV HEADER;

COPY term_gpa(id,term,gpa)
FROM '/home/ian/Galvanize/1_Programming/SQL_I/term_gpa_data.csv'
DELIMITER ',' CSV HEADER;

COPY degrees(id,term,degree)
FROM '/home/ian/Galvanize/1_Programming/SQL_I/degrees_data.csv' 
DELIMITER ',' CSV HEADER;
